        ...
        <>
                ...
                <div key={product._id} className='container p-3 bg-dark my-5 text-center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                        ...
                        <div className="cart_action">
                            <button className="btn btn-warning mx-3" style={{ fontWeight: 'bold' }} onClick={() => decreaseQty(product.productId, 1)}>
                                Qty--
                            </button>
                            <button className="btn btn-info mx-3" style={{ fontWeight: 'bold' }} onClick={() => addToCart(product.productId, product.title, product.price / product.qty, 1, product.imgSrc)}>
                                Qty++
                            </button>
            ...
            {cart?.items?.length > 0 && (
                <div className="container text-center my-3">
                    ...
                    <button className="btn btn-danger mx-3" style={{ fontWeight: 'bold' }} onClick={() => { if (confirm("Are you sure, want clear cart ...?")) { clearCart() } }}>Clear Cart</button>
                </div>
            )}
        </>
    )
