...
const Checkout = () => {
    ...
    const handlePayment = async () => {
        try {
            ...
            // console.log("Order Responce" , orderRespons);
            ...
            var options = {
                ...
                "handler": async function (response) {
                    ...
                    const api = await axios.post(`${url}/payment/verify-payment`, paymentData);
                     ...
                     console.log("✅ Verify Payment Response:", api.data);
        ...
        <>
            <div className="container my-3">
                ...
                <table className="table table-bordered border-primary">
                    <thead>
                        <tr>
                            <th scope="col" className='bg-dark text-light'>Product Details</th>
                            <th scope="col" className='bg-dark text-light'>Shipping Address</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
